...
return [
    ...
    */
    ...
    // frankenphp, not Octane's own 'roadrunner' default. This service runs FrankenPHP in worker
    // mode and its image carries no RoadRunner binary, so the shipped default would make every
    // octane:reload / octane:stop / octane:status fail — and would tell anyone reading this file
    // the wrong thing about what the service actually runs.
